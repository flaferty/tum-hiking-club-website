...
export default function Index() {
  ...
  const scrollToMap = () => {
    document.getElementById("hiking-map")?.scrollIntoView({ behavior: "smooth" });
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        >
          ...
          >
            Join fellow TUM students on unforgettable hiking adventures through Germany's most stunning landscapes.
          </p>
      ...
      <section id="hiking-map" className="container mx-auto px-4 py-12">
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="font-heading text-2xl font-bold md:text-3xl">Hiking Map</h2>
            <p className="text-muted-foreground">Click on a marker to view hike details and enroll</p>
          </div>
            ...
            fallback={
              <div className="h-[400px] md:h-[500px] rounded-xl border border-border bg-muted/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">Map failed to load.</p>
                </div>
              </div>
            }
          >
      ...
      <section className="container mx-auto px-4 pb-8">
        <h2 className="mb-6 font-heading text-2xl font-bold md:text-3xl">Upcoming Adventures</h2>
        ...
        {isLoading ? (
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {upcomingHikes.map((hike, index) => (
              <div key={hike.id} className="animate-slide-up" style={{ animationDelay: `${index * 0.1}s` }}>
          ...
          <Collapsible open={pastHikesOpen} onOpenChange={setPastHikesOpen}>
            <CollapsibleTrigger asChild>
              <Button variant="ghost" className="mb-4 gap-2 text-muted-foreground hover:text-foreground">
                ...
                <ChevronDown className={`h-4 w-4 transition-transform ${pastHikesOpen ? "rotate-180" : ""}`} />
              </Button>
            </CollapsibleTrigger>
            <CollapsibleContent>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
